/* OCI cross-image dedup metrics unit tests (Plan 3 C3.4)
 *
...
{
    const char *name = "dedup: image-index pin contributes via arm64 sub-manifest";
    char root[1024];
...
static void case_unpacked_tree_contributes(const char *scratch)
{
    ...
    seed_unpacked_tree(volume, "fa00000000000000000000000000000000000000000000000000000000000001",
