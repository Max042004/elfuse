...
static void run_happy(const struct happy_case *c)
{
    ...
    if (oci_ref_parse(c->input, &ref, &err) != 0) {
        ...
        snprintf(detail, sizeof(detail),
                 "parse failed unexpectedly: input=%s err=%s",
                 c->input, err ? err : "(null)");
...
static void run_error(const struct error_case *c)
{
    ...
    if (!err || !strstr(err, c->err_substring)) {
        char detail[256];
        snprintf(detail, sizeof(detail),
                 "input=%s: error %s did not contain %s",
                 c->input, err ? err : "(null)", c->err_substring);
        report_fail(c->name, detail);
        return;
    }
...
int main(void)
{
    ...
    struct happy_case happy[] = {
        {"bare repo defaults to docker.io/library and latest",
         "alpine",
         "docker.io/library/alpine:latest",
         "docker.io", "library/alpine", "latest", NULL},
        {"tagged bare repo",
         "alpine:3.20",
         "docker.io/library/alpine:3.20",
         "docker.io", "library/alpine", "3.20", NULL},
        {"two-segment repo skips library/ prefix",
         "myuser/myrepo",
         "docker.io/myuser/myrepo:latest",
         "docker.io", "myuser/myrepo", "latest", NULL},
        {"registry with dot is detected",
         "ghcr.io/owner/img:tag",
         "ghcr.io/owner/img:tag",
         "ghcr.io", "owner/img", "tag", NULL},
        {"localhost is detected as registry",
         "localhost/repo:dev",
         "localhost/repo:dev",
         "localhost", "repo", "dev", NULL},
        {"registry with port preserves port",
         "localhost:5000/repo:dev",
         "localhost:5000/repo:dev",
         "localhost:5000", "repo", "dev", NULL},
        ...
        {"tag+digest keeps both",
         "alpine:3.20@sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
         "docker.io/library/alpine:3.20@sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
         "docker.io", "library/alpine", "3.20", "sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"},
        {"sha512 digest is accepted",
         "repo@sha512:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
        ...
        {"underscore separators inside path",
         "library/foo_bar:tag",
         "docker.io/library/foo_bar:tag",
         "docker.io", "library/foo_bar", "tag", NULL},
        {"double-underscore separator",
         "library/foo__bar:tag",
         "docker.io/library/foo__bar:tag",
         "docker.io", "library/foo__bar", "tag", NULL},
        {"hyphen and dot separators",
         "library/foo-bar.baz:tag",
         "docker.io/library/foo-bar.baz:tag",
         "docker.io", "library/foo-bar.baz", "tag", NULL},
        ...
        {"tag containing dot, hyphen, underscore",
         "alpine:1.2.3-rc1_build",
         "docker.io/library/alpine:1.2.3-rc1_build",
         "docker.io", "library/alpine", "1.2.3-rc1_build", NULL},
    };
    ...
    struct error_case errors[] = {
        ...
        {"uppercase in path rejected",
         "Alpine", "invalid component"},
        {"trailing colon rejected",
         "alpine:", "tag is empty"},
        {"trailing at sign rejected",
         "alpine@", "digest is empty"},
        {"double at sign rejected",
         "a@b@c", "multiple '@'"},
        {"unknown digest algorithm rejected",
         "alpine@md5:0123456789abcdef0123456789abcdef",
         "must be sha256 or sha512"},
        {"short sha256 digest rejected",
         "alpine@sha256:cafe", "hex length"},
        {"uppercase digest hex rejected",
         "alpine@sha256:ABCDEF0123456789abcdef0123456789abcdef0123456789abcdef0123456789",
         "lowercase"},
        {"path component starting with separator",
         "library/.foo:tag", "invalid component"},
        {"path component ending with separator",
         "library/foo-:tag", "invalid component"},
        {"triple-dot separator inside component",
         "library/foo...bar:tag", "invalid component"},
        {"empty path after registry",
        ...
        {"tag too long (129 chars) rejected",
         "alpine:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
         "invalid characters or length"},
        {"tag starting with dot rejected",
         "alpine:.bad", "invalid characters"},
        {"port too long rejected",
         "host:123456/repo", "invalid characters"},
    };
