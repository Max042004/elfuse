                          ...
                          const char **err_msg)
{
    ...
    if (require_string(obj, "architecture", &out->architecture, err_msg,
        ...
        goto fail;
    if (require_string(obj, "os", &out->os, err_msg,
                       "platform missing os",
                           ...
                           const char **err_msg)
{
    ...
    if (require_string(root, "architecture", &out->architecture, err_msg,
        ...
        goto fail;
    if (require_string(root, "os", &out->os, err_msg,
                       "image config missing os",
    ...
    if (cfg) {
        ...
        if (dup_optional_string(cfg, "WorkingDir", &out->config.working_dir,
                                err_msg,
                                "image config WorkingDir must be a string") <
            0)
            goto fail;
        if (dup_string_array(cfg, "Env", &out->config.env, err_msg,
                             ...
                             false) < 0)
            goto fail;
        if (dup_string_array(cfg, "Entrypoint", &out->config.entrypoint,
                             err_msg,
                             "image config Entrypoint must be a string array",
                             false) < 0)
            goto fail;
