 ...
 * Plan 3 layer caches dedup along different axes:
 *
 ...
 *     same shape the C3.3c-ii orchestrator short-circuits on during unpack.
 *
 ...
 *
 * Plan 4 oci status reuses this helper by calling it once per pin and
