 ...
 * helper has no concern with caches; Plan 3 C3.3c moved all cache
...
/* Plan 3 C3.3c-ii: raw-tar populate primitive for the per-layer cache.
 *
...
/* Plan 3 C3.3c-ii: two-pass overlay assembly from a raw per-layer cache
 ...
 * tar content.
 *
 * Known limitation (D8 in the C3.3 design): tar-level hardlink
 * relationships are not reconstructed by the assembler. Each per-file
