 ...
 *
 * Phase 4 F4.7 (issue #31) implements the OCI image-spec User field beyond
 * the numeric shapes the Phase 3 runspec accepted. The User string the
 * image carries is one of seven shapes:
 *
