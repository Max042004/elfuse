 ...
 * pre-launch bridge between oci_runspec_build (Phase 3 commit 2, which
 * decides what argv and what PATH the guest should see) and elfuse_launch
 * (Phase 3 commit 4, which expects a host filesystem path to open):
 *
