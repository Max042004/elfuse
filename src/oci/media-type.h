 ...
 * unsupported per oci-roadmap.md Q3: elfuse cannot fetch the out-of-band
 * payload those layers reference, so rejecting them at parse time is the
 * honest answer rather than carrying a half-supported code path.
 */
