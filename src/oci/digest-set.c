 ...
 * grows geometrically (x2) because Plan 1 collects up to one entry per
 * manifest + config + layer across every pinned image plus every
 * unpacked sysroot, and an O(n) realloc per add would dominate that.
 */
